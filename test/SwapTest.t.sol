...
contract SwapTest is TestHelper {
    ...
    function test_BuyExactInput() public {
        ...
        assertTrue(
            ...
            "User should receive memecoin tokens"
        );
        ...
        assertTrue(
            finalState.price > initialState.price,
    ...
    function test_SellExactInput() public {
        ...
        assertTrue(
            finalState.userWethBalance > initialState.userWethBalance,
            "User's WETH balance should increase"
        );
    ...
    function test_SellExactOutput() public {
        ...
        assertTrue(
            finalState.userMemecoinBalance < initialState.userMemecoinBalance,
            "User's memecoin balance should decrease"
        );
    ...
    function test_ExceedingAvailableLiquidity() public {
        ...
        try this.executeSwapAsExternal(
            isWethCurrency0,
            -int256(excessiveAmount),
            false
        ) {
            ...
            assertTrue(
                ...
                "Swap should not drain all circulating supply"
            );
        } catch {
    ...
    function _createAndInitializePool() internal {
        ...
        (poolId, memecoin, nftId) = poolStateManager.createPumpUp{value: POOL_CREATION_FEE}(
            launchParams,
            ecStrategyId,
            transitionConfig
        );
